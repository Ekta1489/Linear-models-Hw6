...
#Baby's birthweight is associated with Gestational age in weeks. I have included baby's sex, mom's age, mom's race, mom's weight gain and average number of cigarettes smoked per day during pregnancy as these variables can be associated with baby's birthweight.
...
#Based on the violen plots above, we can see that the third model i.e. the model with three way interaction is the best model because it has the minimum RMSE.  
